...
To unify this behavior, you're asked to design a sysAtem using Java Interfaces. The interface will standardize the controls, and each controller will implement them differently.
